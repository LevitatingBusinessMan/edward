...
Edward is inspired by Jekyll.footnote:[Edward Hyde is the name of Dr Jekyll's alter ego] However, Edward uses Tilt for templating instead of Liquid. The freedom provided by Tilt as well as Edwards simplicity create a very powerful environment.
